          ...
          // },
					{
					  ...
					  include: [
					    ...
					    path.resolve(paths.appNodeModules, "react-native-elements"),
					    path.resolve(paths.appNodeModules, "react-native-touchable-scale"),
                ...
                options: {
                  ...
                  plugins: () => [
          ...
          },
					{
					  ...
					  include: path.resolve(paths.appNodeModules, "react-native-vector-icons"),
					},
